...
export const ru: Dictionary = {
  ...
  board: {
    ...
    filterPanelAria: "Фильтр задач",
    filterLabel: "Метка",
    filterAuthor: "Автор",
    filterUnlabeled: "Без метки",
    filterPeriod: "Период",
    filterAnyTime: "Любое время",
    filterToday: "Сегодня",
    filterLast5Days: "Последние 5 дней",
    filterCustom: "Свой",
    filterFrom: "С",
    filterTo: "По",
    filterInbox: "Входящие",
    filterUnread: "Непрочитанные",
    filterNew: "Новые",
    filterUrgent: "Срочные",
    filterHasFile: "С файлом",
    ...
    labels: "Метки",
    labelsAria: "Метки доски",
    closeLabels: "Закрыть метки",
    labelsEmpty: "Пока нет меток.",
    labelRenameAria: "Переименовать метку {name}",
    newTaskLabel: "Новая",
  ...
  cardPage: {
    ...
    urgentBadge: "Срочно",
    labelsAria: "Метки",
    labelCreatePlaceholder: "Новая метка",
    labelCreateAria: "Создать метку",
    labelToggleAria: "Переключить метку {name}",
    labelColorAria: "Сменить цвет метки {name}",
    labelColorsAria: "Цвет метки {name}",
    labelDeleteAria: "Удалить метку {name}",
    labelDeleteConfirm: "Удалить метку {name}?",
    labelDeleteConfirmHint:
      "Она снимется со всех задач на этой доске. Это нельзя отменить.",
    labelDeleteCancel: "Отменить",
    labelDeleteYes: "Удалить",
    ...
    deleteCardConfirm: "Удалить эту задачу?",
    deleteCardConfirmHint:
      "Задача и переписка будут удалены. Это нельзя отменить.",
    deleteCardCancel: "Отмена",
    deleteCardYes: "Удалить",
    saveEdit: "Сохранить",
    cancelEdit: "Отмена",
  ...
  errors: {
    ...
    deleteCard: "Не удалось удалить задачу",
    ...
    createLabel: "Не удалось создать метку",
    labelExists: "Метка с таким именем уже есть",
    labelLimit: "На доске уже 10 меток",
    labelNotFound: "Метка не найдена",
    updateLabel: "Не удалось обновить метку",
    deleteLabel: "Не удалось удалить метку",
  },
};
