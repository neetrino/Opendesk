...
- [x] Фото/видео вложения в карточке и чате (R2, max 200 MB, подсказка ~2 мин)
- [x] В чате: снять фото/видео с камеры или выбрать из галереи
- [x] Голосовые в чате: tap-to-record, затем отправить; камера tap=фото / hold=видео
