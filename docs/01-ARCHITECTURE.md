...
- Установка на телефон (PWA Add to Home Screen): манифест + иконки, без service worker и без офлайна. С доски иконка открывает `/b/{slug}/{joinToken}`
...
| PWA | Manifest + standalone, без SW | Size A: иконка на телефоне без сторов и без кэша RSC |
